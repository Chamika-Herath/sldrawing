...
class Company_Info_Variable_List
{
    ...
    private $company_phone_no = "01";
    private $company_phone_no_02 = "0";
    private $compnay_notification_mobile_no = "0";
    ...
    //    ---------------------------------------
    private $address_line_01 = "No";
    private $address_line_02 = "A";
    private $address_line_03 = "B";
    private $address_street = "";
    private $address_city = "";
    private $country_name = "Sri Lankaa";



    private $app_URL = "AAhttps://www.";
    private $finanace_admin_email_for_notification = "AA";
    private $API_SEO_KEY = "";
    private $Propety_NO = "";
    ...
    private $google_authentication_clent_secret_id = "";
