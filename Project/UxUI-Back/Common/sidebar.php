...
<style>
    ...
    * {
    ...
    /* =========================================================
       DASHBOARD CONTENT AREA (PUSHED BY SIDEBAR)
       ========================================================= */
    .dashboard-content {
    ...
    .erp-sidebar.collapsed ~ .dashboard-content {
...
<aside class="erp-sidebar" id="sidebar">
    <div class="erp-sidebar__header">
        <div class="erp-sidebar__title">Item & Service</div>
    ...
    <nav class="erp-sidebar__menu">
        <button class="erp-sidebar__btn erp-sidebar__btn--active" id="btn_01" onclick="body_01_show()" data-tooltip="List Category">
            <svg class="erp-sidebar__icon" viewBox="0 0 24 24">
                <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/>
            </svg>
            <span class="erp-sidebar__btn-text">List Category</span>
        </button>

        <button class="erp-sidebar__btn" id="btn_02" onclick="body_02_show()" data-tooltip="Item List">
            <svg class="erp-sidebar__icon" viewBox="0 0 24 24">
                <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>
            </svg>
            <span class="erp-sidebar__btn-text">Item List</span>
        </button>

        <button class="erp-sidebar__btn" id="btn_03" onclick="body_03_show()" data-tooltip="Service List">
            <svg class="erp-sidebar__icon" viewBox="0 0 24 24">
                <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/>
            </svg>
            <span class="erp-sidebar__btn-text">Service List</span>
        </button>

        <button class="erp-sidebar__btn" id="btn_04" onclick="body_04_show()" data-tooltip="Brand List">
            <svg class="erp-sidebar__icon" viewBox="0 0 24 24">
                <path d="M17.63 5.84C17.27 5.33 16.67 5 16 5L5 5.01C3.9 5.01 3 5.9 3 7v10c0 1.1.9 1.99 2 1.99L16 19c.67 0 1.27-.33 1.63-.84L22 12l-4.37-6.16zM16 17H5V7h11l3.55 5L16 17z"/>
            </svg>
            <span class="erp-sidebar__btn-text">Brand List</span>
        </button>

        <button class="erp-sidebar__btn" id="btn_05" onclick="body_05_show()" data-tooltip="Tags">
            <svg class="erp-sidebar__icon" viewBox="0 0 24 24">
        ...
        <button class="erp-sidebar__btn" id="btn_06" onclick="body_06_show()" data-tooltip="Opening Balance">
            <svg class="erp-sidebar__icon" viewBox="0 0 24 24">
        ...
        <button class="erp-sidebar__btn" id="btn_07" onclick="body_07_show()" data-tooltip="Barcode">
            <svg class="erp-sidebar__icon" viewBox="0 0 24 24">
        ...
        <button class="erp-sidebar__btn" onclick="back_to_Home_dash_board()" data-tooltip="Back to Dashboard">
            <svg class="erp-sidebar__icon" viewBox="0 0 24 24">
