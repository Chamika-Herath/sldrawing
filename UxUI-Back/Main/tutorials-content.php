    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 40px;">
        ...
        <div class="glass" style="border-radius: 30px; overflow: hidden; transition: 0.3s; cursor: pointer; background: var(--surface);">
            ...
            <div style="padding: 30px;">
                ...
                <p style="color: var(--text-dim); margin-bottom: 25px;">Master facial structures using the Loomis method and realistic skin shading.</p>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: var(--primary); font-weight: 700;">PRO GUIDE</span>
                    <button class="btn" style="padding: 10px 20px; background: var(--secondary); border: 1px solid var(--primary); color: var(--primary); border-radius: 5px; font-weight: 700;">View</button>
                </div>
            </div>
        </div>
        <!-- Coloring -->
