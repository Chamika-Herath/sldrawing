<section class="contact-guide" style="padding: 120px 0; background: url('/assets/images/museum_bg_4.png') center / cover fixed no-repeat; position: relative; overflow: hidden;">
    ...
    <div class="container glass reveal" style="display: grid; grid-template-columns: 1fr 1fr; gap: 80px; padding: 80px; border-radius: 50px; align-items: center; position: relative; z-index: 2;">
        ...
        <div>
            <form style="display: grid; gap: 20px; background: var(--surface); padding: 40px; border-radius: 30px; box-shadow: 0 20px 50px rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.05);">
                <div style="display: grid; gap: 5px;">
                    ...
                    <input type="text" placeholder="e.g. Leonardo da Vinci" style="width: 100%; padding: 18px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.03); font-weight: 600; color: var(--text);">
                </div>
                <div style="display: grid; gap: 5px;">
                    ...
                    <input type="email" placeholder="leo@masterpiece.com" style="width: 100%; padding: 18px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.03); font-weight: 600; color: var(--text);">
                </div>
                <div style="display: grid; gap: 5px;">
                    <label style="font-size: 0.8rem; font-weight: 800; text-transform: uppercase; color: var(--primary); letter-spacing: 1px;">Message</label>
                    <textarea placeholder="Tell us about your artistic journey..." style="width: 100%; padding: 18px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.03); font-weight: 600; color: var(--text); height: 120px; resize: none;"></textarea>
                </div>
                <button type="submit" class="btn-primary" style="margin-top: 10px; width: 100%; font-size: 1.1rem;">Send Message</button>
            </form>
        </div>
    </div>
</section>
