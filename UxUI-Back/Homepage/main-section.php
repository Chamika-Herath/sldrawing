...
<section class="hero hero-section" style="min-height: 100vh; position: relative; overflow: hidden; display: flex; align-items: center; justify-content: center; background: url('/assets/images/portrait_hero.webp') center / cover no-repeat; filter: saturate(1.4) contrast(1.15) brightness(1.1);">
    ...
    <div class="container hero-grid" style="z-index: 1;">
        <div class="hero-text-container">
            ...
            <div class="hero-btn-container">
                <a href="/tutorials" class="btn" style="padding: 18px 45px; background: #fe621d; color: #0b0b0f; text-decoration: none; font-weight: 800; border-radius: 12px; text-transform: uppercase; box-shadow: 0 15px 30px rgba(254,98,29,0.4); transition: all 0.3s ease; font-size: 1.1rem;">Explore Guides</a>
                <a href="/studio" class="btn" style="padding: 18px 45px; border: 2px solid rgba(255,255,255,0.5); color: #fff; text-decoration: none; font-weight: 800; border-radius: 12px; text-transform: uppercase; background: rgba(255,255,255,0.05); backdrop-filter: blur(10px); transition: all 0.3s ease; font-size: 1.1rem;">Open Studio</a>
            </div>
        </div>
    ...
    <script>
        ...
        // Text Rotation
        const heroTexts = [
            { top: "Unleash Your", bottom: "Drawing Vibe" },
