<?php
class cus_sup_list_SIGNLE_DATA_by_main_user_login
{
    ...
    public function __construct($get_main_user_login_id)
    {
        ...
        $get_sql_query = "select * from cus_sup_list where main_user_login_id='" . $this->main_user_login_id . "' and company_id='" . $this->company_id . "'";
        // echo  $get_sql_query;
