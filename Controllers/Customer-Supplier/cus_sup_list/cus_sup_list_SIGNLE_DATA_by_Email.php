<?php
class cus_sup_list_SIGNLE_DATA_by_Email
{
    ...
    public function __construct($get_email)
    {
        ...
        $get_sql_query = "select * from cus_sup_list where email='" . $this->email . "' and company_id='" . $this->company_id . "'";
        // echo  $get_sql_query;
