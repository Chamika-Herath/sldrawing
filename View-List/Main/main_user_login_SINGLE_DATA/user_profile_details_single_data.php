...
if ($main_user_login_SINGLE_DATA_obj->get_state()) {
    ...
    if (isset($_POST['cus_sup_list_details_cus_sup_id'])) {

        $cus_sup_list_SIGNLE_DATA_by_main_user_login_obj = new cus_sup_list_SIGNLE_DATA_by_main_user_login($main_user_login_SINGLE_DATA_obj->get_id());
        if ($cus_sup_list_SIGNLE_DATA_by_main_user_login_obj->get_bool_state()) {

            $state_data['cus_sup_list_id'] = $cus_sup_list_SIGNLE_DATA_by_main_user_login_obj->get_id();
        } else {
            $state_data['cus_sup_list_id'] = "customer suppler not defind";
            $state_data['error'] = "cus_sup list details not found";
        }
    }
